...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className={`${isOpen ? 'translate-x-0' : '-translate-x-[280px]'} fixed left-0 w-[280px] overflow-y-scroll transition-transform duration-300 max-[1024px]:top-0 max-[1024px]:h-screen max-[1024px]:z-50`}>
